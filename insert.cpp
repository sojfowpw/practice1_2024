...
void insert(const string& command, tableJson& tjs) { // вставка
    ...
    string pkFile = "/home/kali/Documents/GitHub/practice1_2024/" + tjs.schemeName + "/" + tableName + "/" + tableName + "_pk_sequence.txt";
    ...
    while (true) {
        string csvFile = "/home/kali/Documents/GitHub/practice1_2024/" + tjs.schemeName + "/" + tableName + "/" + to_string(csvNum) + ".csv";
    ...
    string csvOne = "/home/kali/Documents/GitHub/practice1_2024/" + tjs.schemeName + "/" + tableName + "/1.csv";
    string csvF = "/home/kali/Documents/GitHub/practice1_2024/" + tjs.schemeName + "/" + tableName + "/" + to_string(csvNum) + ".csv";
